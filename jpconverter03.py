...
class MainWindow(QMainWindow):
    ...
    def __init__(self, ui_file):
        ...
        if theUIFileName == 'main1.ui': self.ui = Ui_MainWindow()
        elif theUIFileName == 'main2.ui': self.ui = Ui_MainWindow2()
        else: self.ui = Ui_MainWindow3()
        self.ui.setupUi(self)
        self.uiFileName = ui_file                       # current ui file, specified in code above
    ...
    def moveElements(self, layoutStyle):                      # used for main1.ui
        if layoutStyle=="left":
...
if __name__ == '__main__':
    ...
    window = MainWindow(theUIFileName)
    sys.exit(app.exec_())
